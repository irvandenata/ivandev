...
@section('content')
  {{-- <div id="about-me"
    ...
    <div class="lg:basis-1/2 lg:pt-0 pt-10">
      <h1 class="text-4xl font-bold">Hi There,
        ...
        <div class="flex gap-6 mt-5 static">
          <div class="static" id="instagram">
            ...
            <p class="icon-caption text-sm absolute invisible  font-thin text-center mt-2 bg-background p-1 rounded">
              @irvandenata
            </p>
          </div>
    ...
    <div class="flex w-full">
      <div class="basis-2/3">
        ...
        <div class="flex-row mt-10">
          <ol class="relative border-s border-background dark:border-gray-700">
            @foreach ($workExp as $item)
              <li class="mb-10 ms-6 px-4">
                <span
              ...
              @foreach ($techStack->where('sub_title', 'Frontend') as $item)
                <div id="title-{{ $item->id }}" class="flex-row justify-center static">
                  <div onmouseenter="mouseEnter(event)" onmouseleave="mouseLeave(event)"
                    class="icon-stack p-2 bg-background rounded-lg hover:border-primary hover:border-2 border-2 border-background cursor-pointer">
                    {!! $item->icon !!}
                  </div>
                  <p
                    class="icon-caption text-sm absolute invisible  font-thin text-center mt-2 bg-background p-1 rounded">
                    {{ $item->title }}
                  </p>
                </div>
              @endforeach
  ...
  <div class="snap-madatory snap-center container min-h-screen mx-auto flex items-center" id="projects">
    <div class="">
      <div class="flex justify-between">
        <h1 class="text-3xl font-bold">The project <span class="text-primary">I'm working on</span></h1>
        <a href="{{ route('projects.search') }}"
          class="inline-flex items-center text-lg font-bold hover:bg-background p-2 rounded-lg  text-center text-black bg-blue-700 ">
          See More Projects
  ...
  <div class="snap-madatory snap-center container min-h-screen mx-auto flex justify-center items-center"
    ...
    <div class="w-full">
      ...
      <form class="mt-6 w-8/12 mx-auto" id="form-get-in-touch" onsubmit="sendGetInTouch(event)">
        @csrf
        <div class="mb-6">
