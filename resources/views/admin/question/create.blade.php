                ...
                <div class="row">
                  ...
                  <div class="form-group mb-3 col-12">
                    <div class="form-line">
                      ...
                      <textarea name="question" class="form-control myeditorinstance" rows="10"></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group mb-3 col-12">
                    ...
                    <div id="option">
                      <div class="form-line option">
                        <label for="energy">Option 1</label>
                        <div class="row">
                          <div class="col-10">
                            <input type="text" data-id="1" name="option[]" class="form-control inputOption">
                          </div>
                          <div class="col-2">
                  ...
                  <div class="form-group mb-3 col-12">
                    ...
                    <div class="form-line">
                      ...
                      <textarea name="explanation" class="form-control myeditorinstance" rows="10"></textarea>
                    </div>
                  </div>
                  ...
                  <div class="form-group mb-3 col-12">
                    <div class="form-line">
                      ...
                      <div style="width: 100%" class="m-4 text-center" id="preview">
                        <img src="{{ asset('assets/img/no-image.png') }}" style="width: 50%;" class="mx-auto"
                          alt="">
                      </div>
                    </div>
                  </div>
  ...
  <script>
    ...
    $('#addOption').on('click', function() {
      ...
      <div class="form-line option">
        ...
        $('select[name="answer"]').append(`<option data-id="` + id + `" value="` + length + `">Option ` + length + `</option>`)
      $('.removeOption').on('click', function() {
        $(this).parent().parent().parent().remove();
      $('select[name="answer"]').empty();
      $('.option').each(function(index, value) {
        $(this).find('label').text('Option ' + (index + 1))
        $('select[name="answer"]').append(`<option value="` + (index + 1) + `">Option ` + (index + 1) + `</option>`)
      })
