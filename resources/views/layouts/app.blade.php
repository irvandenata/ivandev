              ...
              <div class="mt-6 flow-root">
                <div class="-my-6 divide-y divide-gray-500/10">
                  <div class="space-y-2 py-6">
                    <a @if (Request::is('/')) href="#about-me" @else href="/#about-me" @endif
                      onclick="closeNav()" class="-mx-3 block rounded-lg px-3 py-2 text-base font-light leading-7 text-gray-900 hover:bg-gray-50">About
                      Me</a>
                    <a @if (Request::is('/')) href="#tech-stack-2" @else href="/#tech-stack-2" @endif
                      onclick="closeNav()" class="-mx-3 block rounded-lg px-3 py-2 text-base font-light leading-7 text-gray-900 hover:bg-gray-50">Tech
                      Stack</a>
                    <a @if (Request::is('/')) href="#tech-stack" @else href="/#tech-stack" @endif
                      onclick="closeNav()" class="-mx-3 block rounded-lg px-3 py-2 text-base font-light leading-7 text-gray-900 hover:bg-gray-50">Work
                      Experiences</a>
                    <a @if (Request::is('/')) href="#projects" @else href="/#projects" @endif
                      onclick="closeNav()" class="-mx-3 block rounded-lg px-3 py-2 text-base font-light leading-7 text-gray-900 hover:bg-gray-50">Projects</a>
                    <a href="{{ route('blog.search') }}"
                  ...
                  <div class="py-6">
                    <a @if (Request::is('/')) href="#get-in-touch" @else href="/#get-in-touch" @endif
                      onclick="closeNav()" class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50">Get
                      In Touch</a>
                  </div>
                </div>
              </div>
