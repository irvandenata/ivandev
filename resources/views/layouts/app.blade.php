...
<body class="w-screen">
  ...
  <div id="navigation" class="fixed top-0 z-10 shadow w-full bg-white">
    <header class="bg-white container  mx-auto ">
      <nav  class="flex px-6 lg:px-0 items-center justify-between py-6" aria-label="Global">
      ...
      <div class="hidden mobile-menu transition ease-in-out delay-150 duration-300" role="dialog" aria-modal="false">
        ...
        <div
          class="fixed inset-y-0 right-0 z-10 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:border-gray-900/10">
          <div class="flex items-center justify-between">
            <a href="/"
            class="-m-1.5 p-1.5 hover:bg-primary hover:text-white hover:animate-bounce hover:rounded hover:scale-100 ">
            <span class="font-bold text-2xl">IVD.</span>
            </a>
            <button type="button" id="exit-menu-mobile" class="-m-2.5 rounded-md p-2.5 text-gray-700 hidden">
  ...
  <div class="snap-y container-fluid static">
      ...
      document.addEventListener('DOMContentLoaded', function() {
        ...
        btnMenuMobile.addEventListener('click', function() {
         console.log('jalan')
          ...
          btnMenuMobile.classList.add('hidden');
          exitMenuMobile.classList.remove('hidden');
        });
        exitMenuMobile.addEventListener('click', function() {
          menuMobile.classList.add('hidden');
          btnMenuMobile.classList.remove('hidden');
          exitMenuMobile.classList.add('hidden');
        });
