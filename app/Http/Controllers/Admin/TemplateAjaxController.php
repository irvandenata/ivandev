...
{
    protected $name = 'Category Question';
    protected $breadcrumb = '<strong>Data</strong> Category Question';
    protected $modul = 'category-question';
    protected $route = 'categories-question';
    protected $view = 'admin.category-question';
    protected $newModel;
    protected $model;
    protected $rows;
    ...
    {
        $this->newModel = new CategoryQuestion();
        $this->model = CategoryQuestion::query();
        $this->rows = [
            'name'=>['Status','Name','Quistion',"Question Per Test",'Duration','Description','Image'],
            'column' => ['status','name','question','amount_question','duration','description','image']
        ];
        $this->createLink = route('admin.categories-question.create');
        $this->storeLink = route('admin.categories-question.store');
        $this->indexLink = route('admin.categories-question.index');
        $this->updateLink = 'admin.categories-question.update';
        $this->editLink = 'admin.categories-question.edit';
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $item->amount_question = $request->amount_question;
